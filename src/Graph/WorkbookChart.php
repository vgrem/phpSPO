...
/**
 * Generated by phpSPO model generator 2020-05-26T22:03:10+00:00 
 */
...
class WorkbookChart extends ClientObject
{
    ...
    public function getAxes()
    {
        if (!$this->isPropertyAvailable("Axes")) {
            $this->setProperty("Axes", new WorkbookChartAxes($this->getContext(), new ResourcePath("Axes", $this->getResourcePath())));
        }
    ...
    public function getDataLabels()
    {
        if (!$this->isPropertyAvailable("DataLabels")) {
            $this->setProperty("DataLabels", new WorkbookChartDataLabels($this->getContext(), new ResourcePath("DataLabels", $this->getResourcePath())));
        }
    ...
    public function getFormat()
    {
        if (!$this->isPropertyAvailable("Format")) {
            $this->setProperty("Format", new WorkbookChartAreaFormat($this->getContext(), new ResourcePath("Format", $this->getResourcePath())));
        }
