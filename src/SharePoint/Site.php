...
class Site extends BaseEntity
{
    ...
    {
        return $this->getProperty("RootWeb", new Web($this->getContext(), new ResourcePath("RootWeb", $this->getResourcePath())));
    }
    /**
    ...
    {
        return $this->getProperty("UserCustomActions", new UserCustomActionCollection($this->getContext(), new ResourcePath("UserCustomActions", $this->getResourcePath()), $this));
    }
    /**
     * Specifies 
