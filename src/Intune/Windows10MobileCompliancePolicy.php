...
class Windows10MobileCompliancePolicy extends Entity
{
    /**
     * @return bool
     */
    ...
    {
        if (!$this->isPropertyAvailable("PasswordRequireToUnlockFromIdle")) {
            return null;
        }
        return $this->getProperty("PasswordRequireToUnlockFromIdle");
    }
    /**
     * @var bool
     */
    public function setPasswordRequireToUnlockFromIdle($value)
    {
        $this->setProperty("PasswordRequireToUnlockFromIdle", $value, true);
    }
    /**
     * @return string
     */
