...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $industry = array(
        ...
        'Dadah Berjadual','Dan Aksesori','Darat','Dasar Dan Peraturan','Data management –Provide documentation including Disaster','Dll','DNA','Dobi','Dokumentasi Dan Panduarah',
